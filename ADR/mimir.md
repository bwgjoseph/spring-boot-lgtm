...
## Context
A production environment requires metric storage that can handle long-term retention (90+ days) and high availability. Standalone Prometheus is limited by local disk size and lacks a native horizontal scaling story for high-cardinality data.
...
2.  **Architecture:**
    ...
    *   **High Availability:** Run **3 replicas** of the Mimir monolithic pod.
