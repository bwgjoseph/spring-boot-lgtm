...
Get-ChildItem -Path "$dashboardsDir" -Directory | ForEach-Object {
    ...
    Write-Host "Syncing folder: $folderName to ConfigMap: $cmName..." -NoNewline
    ...
    kubectl annotate configmap $cmName grafana_folder=$folderName -n $namespace --overwrite | Out-Null
